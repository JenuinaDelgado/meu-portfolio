        ...
        <Card>
          <Row>
            <Col s={12} m={12}>
              ...
              <div>
              <li><a class="github" href="https://github.com/JenuinaDelgado"><img src={gith} height="30px" /></a></li>
              </div>   
              <div>
              <li><a class="instagram" href="https://www.instagram.com/genugomez/?hl=p"><img src={insta} height="30px" /></a></li>
              </div>   
            </Col>
          </Row>  
        </Card>
